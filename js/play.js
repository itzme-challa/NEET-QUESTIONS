document.addEventListener('DOMContentLoaded', () => {
    ...
    const requiredElements = [
        'subjectScreen', 'chapterScreen', 'quizTypeScreen', 'quizScreen',
        'resetBtn', 'backToSubjects', 'backToChapters',
        'subjectCard', 'chapterCard', 'quizTypeCard',
        'chapterList', 'quizTypeList', 'startQuizBtn',
    ...
    function showScreen(screenName) {
        const screens = ['subject', 'chapter', 'quizType', 'quiz'];
    ...
    async function handleChapterSelect(chapter) {
        ...
        // Extract unique quiz types for the selected chapter
    ...
    function resetSelections(level) {
        const levels = ['subject', 'chapter', 'quizType'];
